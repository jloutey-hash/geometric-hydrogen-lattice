"""
SU(3) Generators v5: Algebraic Closure Method
==============================================
Based on 09_su3_v5_algebraic_closure.md

Philosophy: Build E12 and E23 with GT formulas, then derive ALL other operators
algebraically to guarantee self-consistency. T3 and T8 come from commutators,
not external normalizations.

Reference: Biedenharn-Louck formalism with l-index shift
"""
...
class SU3OperatorsV5:
    """SU(3) operators via algebraic closure from E12 and E23."""
    ...
    def _build_E12(self):
        ...
        for i, (m13, m23, m33, m12, m22, m11) in enumerate(self.states):
            ...
            # GT formula: sqrt(|(l12 - l11) * (l22 - l11 - 1)|)
            factor1 = l12 - l11
            factor2 = l22 - l11 - 1
            
            coeff = np.sqrt(abs(factor1 * factor2))
            E12[j, i] = coeff
