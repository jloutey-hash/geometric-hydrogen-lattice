"""
SU(3) Operators v11: Corrected Normalization
=============================================
- v8 + normalization fixes to match Tr(λᵢ²) = 2
- E23, E32: multiply by √2
- E13, E31: multiply by √2
- T8: multiply by √3

This gives constant Casimir eigenvalues matching Gell-Mann matrices.
"""
...
class SU3OperatorsV11:
    """SU(3) operators: GT formulas with corrected normalization for trace norms."""
    ...
    def __init__(self, p, q):
        ...
        self._T8 = self._build_T8_weight() * np.sqrt(3)  # Normalization correction
        ...
        # E13 via commutator (normalization is inherited from E12 and E23)
