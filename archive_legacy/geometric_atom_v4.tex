...
\begin{align}
    ...
    &= -\frac{(n-l)(3n + 2l + 1)}{16} \label{eq:commutator}
\end{align}
...
\end{align}
This matches the NIST experimental value of 121.567 nm to within 0.05\%, with the small discrepancy due to QED corrections (Lamb shift, ~1000 MHz) not included in the pure Coulomb Hamiltonian.
...
\begin{enumerate}
    \item \textbf{Solves the Rydberg scaling problem}: $O(n^2)$ states versus $O(n^7)$ for grid DVR—a $10^3$--$10^5\times$ reduction for $n=100$.
